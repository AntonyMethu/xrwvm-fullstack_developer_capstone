...
const Header = () => {
    const logout = async (e) => {
        ...
        if (json) {
            ...
            sessionStorage.removeItem('username'); // Clear session first
            alert("Logging out " + username + "..."); // Show alert second
            window.location.href = window.location.origin; // Redirect last
        }
        else {
